...
import { createPost, editPost, getPosts } from "../../redux/reducers/postsSlice";
import "./PostModal.css";
import { closePostModal } from "../../redux/reducers/postModalSlice";
...
export default function PostModal() {
  ...
  return (
    ...
    :
    <div onClick={() => dispatch(getPosts())}>Get post</div>
